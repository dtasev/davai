        ...
        <div className="flex items-center gap-1.5">
          ...
          {onDelete && (
            <button
              ...
              data-testid="delete-sprint-button"
        ...
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="min-w-0 flex-1">
            {isEditing ? (
              <input
                type="text"
                data-testid="edit-sprint-name-input"
    ...
    >
      <div className="space-y-3.5">
          ...
          <div className="p-3 bg-rose-950/40 border border-rose-800/60 rounded-lg flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5">
            ...
            <div className="flex items-center gap-2 self-end sm:self-auto shrink-0">
              ...
              <button
                type="button"
                disabled={isDeleting}
                data-testid="confirm-delete-sprint-button"
                onClick={async () => {
                  if (!onDelete) return
                  setIsDeleting(true)
                  try {
        ...
        <div className="space-y-1">
          ...
          {isEditing ? (
            <textarea
              data-testid="edit-sprint-description-input"
              aria-label="Edit Sprint Description"
