          ...
          {sprints.map(s => {
            ...
            return (
              <div
                ...
                className="group p-4 rounded-xl bg-zinc-900/90 border border-zinc-800 hover:border-amber-500/40 transition cursor-pointer flex flex-col justify-between"
              ...
              >
                <div>
                  <div className="flex items-center justify-between text-xs mb-1">
                    ...
                    {linkedRelease && (
                      <span className="text-[10px] px-1.5 py-0.5 rounded bg-zinc-800 text-indigo-300 font-medium flex items-center gap-1">
