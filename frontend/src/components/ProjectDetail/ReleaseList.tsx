        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3.5">
          {releases.map(r => (
            <div
              ...
              className="group p-4 rounded-xl bg-zinc-900/90 border border-zinc-800 hover:border-indigo-500/40 transition cursor-pointer flex flex-col justify-between"
