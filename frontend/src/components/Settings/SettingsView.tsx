  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6" data-testid="settings-view">
      ...
      <div className="bg-zinc-900/50 border border-zinc-800/80 rounded-xl p-4 sm:p-5 shadow-sm">
        <h2 className="text-xs font-semibold uppercase tracking-wider text-zinc-400 mb-3.5 flex items-center gap-2">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-zinc-400 mt-0.5">{userProfile.email}</div>
                <div className="text-[11px] text-zinc-500 mt-0.5">User ID: #{userProfile.id}</div>
              </div>
            </div>

            <div className="px-3 py-1.5 rounded-lg bg-zinc-950/60 border border-zinc-800/80 text-xs text-zinc-400 flex items-center gap-2 self-start sm:self-center">
              <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
              <span>Session Authenticated</span>
            </div>
          </div>
        ) : (
          <div className="p-3.5 rounded-lg bg-amber-950/20 border border-amber-800/40 text-amber-300 text-xs flex items-start gap-2.5">
      ...
      <div className="bg-zinc-900/50 border border-zinc-800/80 rounded-xl p-4 sm:p-5 shadow-sm space-y-3.5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-medium text-xs flex items-center gap-1.5 transition shadow-sm disabled:opacity-40 self-start sm:self-auto"
          >
          ...
          <form onSubmit={handleCreate} className="space-y-3.5">
            ...
            <div className="flex items-center justify-end gap-2 pt-2 border-t border-zinc-800/60">
              ...
              <button
                ...
                className="px-3.5 py-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-medium text-xs flex items-center gap-1.5 transition disabled:opacity-50"
              >
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 px-2.5 py-1.5 rounded-lg bg-zinc-950 border border-zinc-800 font-mono text-xs text-indigo-300 select-all"
                />
                <button
                  type="button"
                  onClick={() => copyToClipboard(generatedKey.raw_key, 'key')}
                  className="px-3 py-1.5 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-200 text-xs font-medium flex items-center gap-1 transition shrink-0"
                >
